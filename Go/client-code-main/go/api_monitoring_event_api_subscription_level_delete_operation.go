...
type MonitoringEventAPISubscriptionLevelDELETEOperationApiService service
/*
MonitoringEventAPISubscriptionLevelDELETEOperationApiService Deletes an already existing monitoring event subscription
...
*/
func (a *MonitoringEventAPISubscriptionLevelDELETEOperationApiService) ScsAsIdSubscriptionsSubscriptionIdDelete(ctx context.Context, scsAsId string, subscriptionId string) ([]MonitoringEventReport, *http.Response, error) {
	var (
