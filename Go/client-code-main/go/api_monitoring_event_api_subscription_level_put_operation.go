...
type MonitoringEventAPISubscriptionLevelPUTOperationApiService service
/*
MonitoringEventAPISubscriptionLevelPUTOperationApiService Updates/replaces an existing subscription resource
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Parameters to update/replace the existing subscription
...
*/
func (a *MonitoringEventAPISubscriptionLevelPUTOperationApiService) ScsAsIdSubscriptionsSubscriptionIdPut(ctx context.Context, body MonitoringEventSubscription, scsAsId string, subscriptionId string) (MonitoringEventSubscription, *http.Response, error) {
	var (
